package com.weibo.recycleview.recyclerView;
...
/**
 * Created by 巴巴 on 2016/10/29.
 */
public class CardLayoutManager extends RecyclerView.LayoutManager {
    public static final int DEFAULT_GROUP_SIZE = 5;

    private int mGroupSize,mHorizontalOffset,mVerticalOffset,mTotalWidth,mTotalHeight,mGravityOffset;
