package com.weibo.recycleview.materiaEditext;
...
/**
 * Created by 巴巴 on 2016/11/12.
 */

public class MateriaEditext extends EditText {
    ...
    public MateriaEditext(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs); // 初始化
    }

    public MateriaEditext(Context context, AttributeSet attrs, int defStyleAttr) {
